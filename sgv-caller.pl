...
use File::Copy;
use FindBin;
#version 1.001, at 2022.6.20
#version 1.3 the comparasion between name2ID and raw_variants file is added
#version 1.4 When gzip test (gzip -t -v) failed, key word "Not OK", "invalid" and "error" will be catch to stop the software

my $script_dir = $FindBin::RealBin;
#print "Running sgv-caller in $script_dir\n";
