...
my %opts;
getopts('i:o:', \%opts);
my $input_vari_info_file = $opts{'i'} or die "use: $0 -i input_vari_info_file -o output_folder\n";
#my $input_cds_file = $opts{'r'} or die "use: $0 -i input_cds_file -r input_cds_file -j input_vari_info_file -o output_folder\n";
my $output_folder = $opts{'o'} or die "use: $0 -i input_vari_info_file -o output_folder\n";
#my $RNA_anno = $opts{'r'} or die "use: $0 -i input_cds_file -j input_vari_info_file -o output_folder\n";

my $input_cds_file = "NC_045512.cds.Exc1ab.overlapAdded.fas";
if (!(-e $input_cds_file)){
	print "Plese put cds file $input_cds_file in the folder!";
	break;
}
print "Reference cds is $input_cds_file\n";
...
my %cds = &read_fasta($input_cds_file);
my %cds_info;
my %vari_gene;
my %vari_codon;
my %vari_aa;
